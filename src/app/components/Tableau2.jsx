        ...
        <table>
            <thead>
              <tr className="border-b-2 border-[#2BD6D9] ">
                <th className="font-bold text-white text-capitalize "> Identifiant </th>
                <th className="font-bold text-white text-capitalize">
                  Taille
                </th>
                <th className="font-bold text-white text-capitalize"> Date de création </th>
                <th className="font-bold text-white text-capitalize">
                  UID utilisateur
                </th>
              </tr>
            ...
            <tbody>
              <tr className="border-b-2 border-[#2BD6D9]">
                ...
                <td className="text-white px-10 py-3">22 avr. 2024</td>
                <td className="text-white px-10 py-3">09fe49b34d2b471cac0436c9e</td>
              </tr>
            </tbody>
          </table>
        </div>
