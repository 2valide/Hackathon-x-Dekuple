    ...
    <div className="w-[42rem] h-[31.25rem] bg-[#35264A] rounded-xl text-white">
      <div className="p-[1rem]">
        <div className="flex justify-between w-[18.75]">
          <Image src="/img/House_User.svg" width={30} height={20} alt="House" />
          <Image
      ...
      <div>
        <table>
          ...
          <tbody>
            <tr>
              <td className="border-t-2 border-r-2 border-[#2BD6D9] px-4 py-2 text-bold">
                User
              </td>
              <td className="border-t-2 border-r-2 border-[#2BD6D9] px-4 py-2 text-bold">
                09fe49b34d2b471cac0436c9e
              </td>
              <td className="border-t-2 border-[#2BD6D9] px-4 py-2 text-bold">
